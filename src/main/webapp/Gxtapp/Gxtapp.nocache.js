...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "Gxtapp" because\n';
  ...
  $wnd.__gwt_activeModules['Gxtapp'] = {
    'moduleName' : 'Gxtapp',
    'bindings' : function() {
      return {};
    }
 ...
 * "/Gxtapp.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['Gxtapp'].superdevmode = true;

  var expectedSuffix = '/Gxtapp.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + Gxtapp + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:Gxtapp';
  var devModeSessionKey = '__gwtDevModeSession:Gxtapp';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/Gxtapp/Gxtapp.nocache.js';
  ...
  $wnd.__gwt_activeModules['Gxtapp'].canRedirect = true;
  $wnd.__gwt_activeModules['Gxtapp'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/Gxtapp?user.agent=' + ua + '&_callback=' + callback;
